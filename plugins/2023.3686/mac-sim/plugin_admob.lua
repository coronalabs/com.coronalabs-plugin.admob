...
function lib.updateConsentForm()
    showWarning("admob.updateConsentForm()")
end

function lib.loadConsentForm()
    showWarning("admob.loadConsentForm()")
end

function lib.showConsentForm()
    showWarning("admob.showConsentForm()")
end

function lib.getConsentFormStatus()
    showWarning("admob.getConsentFormStatus()")
end
